...
初始模版的来源非常感谢 [leopardpan](leopardpan.github.io)在git的分享。
...
> $ git clone https://github.com/NingSM/NingSM.github.io

或者直接[下载博客源码](https://github.com/NingSM/NingSM.github.io)   

进NingSM.github.io/ 目录下， 开启本地服务 
...
如果在部署博客的时候发现问题，可以直接在[Issues](https://github.com/NingSM/NingSM.github.io/issues)里面提问。        
